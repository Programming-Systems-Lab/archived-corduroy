...
/**
 * To do list:
 * 1. Is it going to be possible to do pre-meta tests using "assumes"?
 * 2. Maybe allow for the JML notation \old(x) which returns the value of x before the method was called
 *
 */


public class MTestProcessor
{
	...
	MTestProcessor p = new MTestProcessor();
	p.scan(args[0]);
    }


    public MTestProcessor()
    {
